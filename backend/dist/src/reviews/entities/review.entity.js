...
__decorate([
    (0, typeorm_1.ManyToOne)((type) => user_entity_1.UserEntity, (user) => user.reviews, { onDelete: 'CASCADE' }),
    __metadata("design:type", user_entity_1.UserEntity)
], ReviewEntity.prototype, "user", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)((type) => product_entity_1.ProductEntity, (prod) => prod.reviews, { onDelete: 'CASCADE' }),
